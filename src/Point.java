...
public class Point {
    ...
    public Point add(float s, Vec V) {
        x+=s*V.x;
        y+=s*V.y;
        z+=s*V.z;
        return this;
    ...
    public static Point P(Point P, Vec V) {
        // P+V
        return new Point(P.x + V.x, P.y + V.y, P.z + V.z);
    }
    public static Point P(Point P, float s, Vec V) {
        // P+sV
        return new Point(P.x+s*V.x,P.y+s*V.y,P.z+s*V.z);
    }
    public static Point P(Point O, float x, Vec I, float y, Vec J) {
        // O+xI+yJ
        return P(O.x+x*I.x+y*J.x,O.y+x*I.y+y*J.y,O.z+x*I.z+y*J.z);
    }
    public static Point P(Point O, float x, Vec I, float y, Vec J, float z, Vec K) {
        // O+xI+yJ+kZ
        return P(O.x+x*I.x+y*J.x+z*K.x,O.y+x*I.y+y*J.y+z*K.y,O.z+x*I.z+y*J.z+z*K.z);
    }
    public static Point R(Point P, float a, Vec I, Vec J, Point G) {
